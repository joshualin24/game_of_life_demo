...
\title{Formatting Instructions for the Representations for the Physical Sciences Workshop 2026}
...
\section{Submission of papers to the Representations for the Physical Sciences Workshop 2026}
...
Papers submitted to the Representations for the Physical Sciences Workshop 2026
must be prepared according to the instructions presented here. Short Papers may
only be up to {\bf four} pages long, including figures. References and optional
technical appendices do not count as content pages.
...
included in the same PDF as the main paper. There is no page limit for the
technical appendices. Additional files are not allowed, but authors may link to
properly anonymized code and/or data repositories.
